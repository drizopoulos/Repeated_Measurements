...
We continuw by fitting a zero-inflated negative binomial mixed model, with only fixed effects in the logistic regression model for the first latent class (i.e., the class of only zeros). This is achieved with the following syntax:
