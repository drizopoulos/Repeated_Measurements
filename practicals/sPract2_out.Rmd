...
*marginal residuals* and the *conditional residuals*. We shart with the standardized 
...
more spread for larger fitted values. Though this behaviour may be influenced by the 
